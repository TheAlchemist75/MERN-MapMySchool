...
// Define fetchBookmarks function
...
function Sidebar() {
  ...
  useEffect(() => {
    fetchBookmarks(setBookmarkedItems); // Call fetchBookmarks function here
  }, []);
  ...
  const handleBookmark = async (item) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        fetchBookmarks(setBookmarkedItems); // Optionally refetch bookmarks after saving
      } else {
